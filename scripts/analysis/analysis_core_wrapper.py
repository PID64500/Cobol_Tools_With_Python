...
from analysis_core import Paragraph, Caller, ExitEvent, AnalysisResult

logger = logging.getLogger(__name__)

def analyze_program(etude_path: str):
    """
    Façade de compatibilité :
    délègue vers analysis_core.analyze_program(etude_path).
    """
    return analysis_core.analyze_program(str(etude_path))
